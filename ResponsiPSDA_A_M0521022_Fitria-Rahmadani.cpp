...
void DataBuku() {
    ...
    cout << "(((((((((((Kode menunjukkan tempat buku)))))))))))" << endl;
    cout << "---------------------------------------------------------" << endl;
    cout << "| Kode\t|\tJudul\t\tStok\t\tHarga\t|" << endl;
    cout << "---------------------------------------------------------" << endl;

    //Iterasi elemen-elemen BookData sebagai daftar buku
    for(It = BookData.begin() ; It != BookData.end() ; ++It) {
        cout << "| " << It -> first << "\t|" << It -> second.title << "\t\t" << It -> second.stock << "\t\t" << It -> second.price << "\t|" << endl;
    }
    cout << "---------------------------------------------------------" << endl << endl;
}
...
//Fungsi untuk membentuk graph dan cek tempat
void graphTempatBuku() {
    ...
    cout << endl << endl ;
    cout << "*****MENU CEK TEMPAT BUKU*****" << endl;
    cout << "1) IN " << endl;
    cout << "2) FANTASY " << endl;
    cout << "3) FILSAFAT " << endl;
    cout << "4) HORROR " << endl;
    ...
    for(int i = 0; i < jml; i++) {
        ...
        if(Code == "F20" || Code == "F21" || Code == "F22" || Code == "H30" || Code == "H31" || Code == "FI40" || Code == "FI41" ||Code == "T50" || Code == "T51") {
            ...
            if(BookData[Code].stock < qty){
                ...
                //Mengurangi stok buku sesuai dengan masukan pengunjung
